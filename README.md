...
After having the invoice number field we can draw a random sample of 20% of invoices (script and some analysis [here](https://github.com/vikozlov89/iowa_liquor_sales_eda/blob/master/notebooks/RandomSampleCreation.ipynb))
...
Some basic analysis you may find here (unfortunately, I have lack of time and can't finish the job properly, but I thing you may find my skills useful after taking a look at this [notebook](https://github.com/vikozlov89/iowa_liquor_sales_eda/blob/master/notebooks/BasicAnalysis.ipynb)).
